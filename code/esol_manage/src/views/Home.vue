	...
	<el-container class="home">
	  <el-header>
		  <el-row>
			  ...
			  <el-col :span="12" style="text-align: right;box-sizing: border-box;padding-top: 0.5rem;">
				  <el-dropdown size="medium" @command="handleCommand">
					<el-avatar src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png"></el-avatar>
					<el-dropdown-menu slot="dropdown">
					  <el-dropdown-item icon="el-icon-lock" command="u">修改密码</el-dropdown-item>
					  <el-dropdown-item icon="el-icon-connection" command="l">注销</el-dropdown-item>
					</el-dropdown-menu>
				  </el-dropdown>
			  </el-col>
		  </el-row>
