		...
		<el-dialog title="考试信息" :visible.sync="dialogFormVisible">
		  <el-form :model="datainfo"  style="text-align: left;">
		    ...
		    <el-form-item label="考试时长" label-width="120px">
		      <el-input v-model="datainfo.duration" type="number" min="0" step="1" placeholder="请输入"></el-input>
		    </el-form-item>
		    <el-form-item label="考试次数" label-width="120px">
		      <el-input v-model="datainfo.maxNum" type="number" min="0" step="1" placeholder="请输入"></el-input>
		    </el-form-item>
		    <el-form-item label="分数结算规则" label-width="120px">
			  <el-select v-model="datainfo.sorceRule" size="medium" placeholder="请选择">
				  <el-option
					label="最高分"
					:value="1">
				  </el-option>
		    ...
		    <el-form-item label="总分" label-width="120px">
		      <el-input v-model="datainfo.totalSorce" type="number" min="0" step="1" placeholder="请输入"></el-input>
		    </el-form-item>
		    <el-form-item label="试卷生成规则" label-width="120px">
			  <el-select v-model="datainfo.questionRule" size="medium" placeholder="请选择">
				  <el-option
					label="预先生成"
					:value="1">
				  </el-option>
		    ...
		    <el-form-item label="单选题数" label-width="120px">
		      <el-input v-model="datainfo.radioNum" type="number" min="0" step="1" placeholder="请输入"></el-input>
		    </el-form-item>
		    <el-form-item label="多选题数" label-width="120px">
		      <el-input v-model="datainfo.mulitpleNum" type="number" min="0" step="1" placeholder="请输入"></el-input>
		    </el-form-item>
		    <el-form-item label="判断题数" label-width="120px">
		      <el-input v-model="datainfo.judgeNum" type="number" min="0" step="1" placeholder="请输入"></el-input>
		    </el-form-item>
...
export default {
  ...
  methods: {
	  ...
	  search(){
		let that = this;
		this.$post(this, "/exam/list", this.$stringify({
